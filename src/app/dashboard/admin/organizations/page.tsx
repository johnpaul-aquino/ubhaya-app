...
import { OrganizationTable, CreateOrgAdminForm } from '@/components/admin';
import { Skeleton } from '@/components/ui/skeleton';
import { RefreshCw, Search, Building2, Filter } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <CreateOrgAdminForm onSuccess={fetchOrganizations} />
          <Button
            variant="outline"
            size="icon"
