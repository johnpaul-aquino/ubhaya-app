...
>(({ className, children, error, success, selectSize = "md", ...props }, ref) => {
  const sizeClasses = {
    sm: "h-8 px-3 text-xs",
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        success && "border-[hsl(var(--success-500))] focus:ring-[hsl(var(--success-500))]",
        className
      )}
      {...props}
    >
...
/**
 * Enhanced Select wrapper with error/success states
 */
